# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2016-10-01 22:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_mileage', models.IntegerField(null=True)),
                ('amount_due', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
                ('customer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='data_app.Customer')),
            ],
        ),
        migrations.CreateModel(
            name='Pet',
